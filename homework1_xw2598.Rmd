...
ggplot(dt_frame2, mapping = aes(x, y))+
  geom_point(data = dt_frame2, aes(x, y), 
             col = ifelse(dt_frame2$vc_logic, "red", "blue"), size =1 ) +
...
ggplot(dt_frame2, mapping = aes(x, y))+
  geom_point(
  data = dt_frame2, aes(x, y), 
  col = ifelse(dt_frame2$vc_num, "blue", "green"), size =1 ) +
  labs(title = "scatterplot of y vs x ")

#Create scarrerplot of y vs x and the point colored by factor variable
ggplot(dt_frame2, mapping = aes(x, y))+
  geom_point(data = dt_frame2, aes(x, y),
             col = ifelse(dt_frame2$vc_factor == "TRUE", "purple", "violet"), size =1 ) +
  labs(title = "scatterplot of y vs x ")
